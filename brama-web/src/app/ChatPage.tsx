...
const BACKDROP =
  'chat-backdrop fixed inset-0 -z-10 pointer-events-none ' +
    ...
    <>
      ...
      >
        ...
        <header className="site-header chat-header">
          ...
          >
            <a
              className="chat-brand inline-flex items-center gap-[var(--space-3)] text-[var(--color-text)] text-[length:var(--font-size-lg)] font-bold no-underline"
              href="/"
            ...
            <div className="header-actions chat-header-actions">
              <RoleModeSwitch />
              <AccessibilityToggle />
              <LanguageSwitcher />
            </div>
