...
export const resources = {
  en: {
    translation: {
      ...
      lifeEvents: {
        ...
        intro: 'Pick a situation — we will build a verified action plan.',
        citizenship: 'Your status',
        build: 'Build plan',
        loading: 'Building the plan…',
        checklist: 'Checklist',
        details: 'Details',
        requiresFirst: 'Do this first',
        external: 'Outside City Hall',
        serviceCard: 'Service card',
        map: 'Map',
        back: 'Other situation',
        error: 'Could not build the plan. Please try again.',
        events: {
          moving_to_lublin: 'Moving to Lublin',
          lost_documents: 'Lost documents',
          starting_business: 'Starting a business',
        },
        citizenshipGroups: {
          polish: 'Polish citizen',
          ukrainian_temp_protection: 'Temporary protection (Ukraine)',
          foreigner: 'Foreigner',
        },
      },
    },
  ...
  pl: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Sytuacje życiowe',
        intro: 'Wybierz sytuację — przygotujemy zweryfikowany plan działania.',
        citizenship: 'Twój status',
        build: 'Pokaż plan',
        loading: 'Buduję plan…',
        checklist: 'Lista kroków',
        details: 'Szczegóły',
        requiresFirst: 'Najpierw załatw',
        external: 'Poza Urzędem Miasta',
        serviceCard: 'Karta usługi',
        map: 'Mapa',
        back: 'Inna sytuacja',
        error: 'Nie udało się zbudować planu. Spróbuj ponownie.',
        events: {
          moving_to_lublin: 'Przeprowadzka do Lublina',
          lost_documents: 'Utrata dokumentów',
          starting_business: 'Założenie działalności',
        },
        citizenshipGroups: {
          polish: 'Obywatel/ka RP',
          ukrainian_temp_protection: 'Ochrona czasowa (Ukraina)',
          foreigner: 'Cudzoziemiec/ka',
        },
      },
    },
  },
  fr: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Situations de vie',
        intro: 'Choisissez une situation — nous établirons un plan d’action vérifié.',
        citizenship: 'Votre statut',
        build: 'Afficher le plan',
        loading: 'Création du plan…',
        checklist: 'Liste des étapes',
        details: 'Détails',
        requiresFirst: 'À faire d’abord',
        external: 'En dehors de la mairie',
        serviceCard: 'Fiche de service',
        map: 'Carte',
        back: 'Autre situation',
        error: 'Impossible de créer le plan. Veuillez réessayer.',
        events: {
          moving_to_lublin: 'Déménagement à Lublin',
          lost_documents: 'Documents perdus',
          starting_business: 'Créer une entreprise',
        },
        citizenshipGroups: {
          polish: 'Citoyen(ne) polonais(e)',
          ukrainian_temp_protection: 'Protection temporaire (Ukraine)',
  ...
  es: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Situaciones de la vida',
        intro: 'Elige una situación: crearemos un plan de acción verificado.',
        citizenship: 'Tu situación',
        build: 'Mostrar plan',
        loading: 'Creando el plan…',
        checklist: 'Lista de pasos',
        details: 'Detalles',
        requiresFirst: 'Haz esto primero',
        external: 'Fuera del Ayuntamiento',
        serviceCard: 'Ficha de servicio',
        map: 'Mapa',
        back: 'Otra situación',
        error: 'No se pudo crear el plan. Inténtalo de nuevo.',
        events: {
          moving_to_lublin: 'Mudarse a Lublin',
          lost_documents: 'Documentos perdidos',
          starting_business: 'Crear una empresa',
        },
        citizenshipGroups: {
          polish: 'Ciudadano/a polaco/a',
          ukrainian_temp_protection: 'Protección temporal (Ucrania)',
  ...
  cs: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Životní situace',
        intro: 'Vyberte situaci — připravíme ověřený plán postupu.',
        citizenship: 'Váš status',
        build: 'Zobrazit plán',
        loading: 'Sestavuji plán…',
        checklist: 'Seznam kroků',
        details: 'Podrobnosti',
        requiresFirst: 'Nejprve vyřiďte',
        external: 'Mimo městský úřad',
        serviceCard: 'Karta služby',
        map: 'Mapa',
        back: 'Jiná situace',
        error: 'Plán se nepodařilo sestavit. Zkuste to znovu.',
        events: {
          moving_to_lublin: 'Stěhování do Lublinu',
          lost_documents: 'Ztráta dokladů',
          starting_business: 'Založení podnikání',
        },
        citizenshipGroups: {
          polish: 'Občan(ka) Polska',
          ukrainian_temp_protection: 'Dočasná ochrana (Ukrajina)',
  ...
  uk: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Життєві ситуації',
        intro: 'Оберіть ситуацію — ми складемо перевірений план дій.',
        citizenship: 'Ваш статус',
        build: 'Показати план',
        loading: 'Складаю план…',
        checklist: 'Перелік кроків',
        details: 'Деталі',
        requiresFirst: 'Спершу зробіть',
        external: 'Поза міською радою',
        serviceCard: 'Картка послуги',
        map: 'Карта',
        back: 'Інша ситуація',
        error: 'Не вдалося скласти план. Спробуйте ще раз.',
        events: {
          moving_to_lublin: 'Переїзд до Любліна',
          lost_documents: 'Втрата документів',
          starting_business: 'Відкриття бізнесу',
        },
        citizenshipGroups: {
          polish: 'Громадянин(ка) Польщі',
          ukrainian_temp_protection: 'Тимчасовий захист (Україна)',
          foreigner: 'Іноземець(ка)',
        },
      },
    },
  },
  de: {
    translation: {
      ...
      lifeEvents: {
        heading: 'Lebenssituationen',
        intro: 'Wählen Sie eine Situation — wir erstellen einen geprüften Aktionsplan.',
        citizenship: 'Ihr Status',
        build: 'Plan anzeigen',
        loading: 'Plan wird erstellt…',
        checklist: 'Checkliste',
        details: 'Details',
        requiresFirst: 'Zuerst erledigen',
        external: 'Außerhalb des Stadtamts',
        serviceCard: 'Servicekarte',
        map: 'Karte',
        back: 'Andere Situation',
        error: 'Der Plan konnte nicht erstellt werden. Bitte versuchen Sie es erneut.',
        events: {
          moving_to_lublin: 'Umzug nach Lublin',
          lost_documents: 'Verlorene Dokumente',
          starting_business: 'Unternehmensgründung',
        },
        citizenshipGroups: {
          polish: 'Polnische(r) Staatsbürger(in)',
          ukrainian_temp_protection: 'Vorübergehender Schutz (Ukraine)',
